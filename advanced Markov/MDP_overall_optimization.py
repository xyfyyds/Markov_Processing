...
'''
    MDP overall optimization, Q-learning is used
'''
...
def get_reward(battery_level, price_state, demand_state, solar_state, action, hour):
    ...
    if action == 0:  # charge
        ...
        battery_level = max(0, battery_level - demand)  # battery_level --, > 0
    else:  # idle
...
# Q-learning
episodes = 10000  # time of training
...
for episode in range(episodes):
    ...
    while i <= 1000:
        ...
        # get the reward and the next states
        ...
        # to learn if meet the stop condition, the condition can be changed
        i += 1
        if battery_state >= 50:
            break
